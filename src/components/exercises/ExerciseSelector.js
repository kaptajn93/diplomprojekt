...
else if (this.state.exerciseSelection.className === 'PostitExercise')
return (<PostitExercise exercisesStatusChanged={this.props.exercisesStatusChanged} liveExercise={this.props.liveExercise} exerciseId={this.state.exerciseSelection.exerciseId} exercise={this.state.exerciseSelection} scoreCard={this.props.scoreCard}> </PostitExercise> );
